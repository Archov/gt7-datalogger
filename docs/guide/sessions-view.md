...
The drivetrain badge comes from the authoritative gt-telemetry vehicle definition.
Wheelspin characterization maps that published layout to the powered wheels and never
guesses from telemetry or asks the user to assign a drivetrain.
## Category filter
