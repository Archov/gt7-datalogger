...
Open `http://<pi-ip>:8000` from any device on the LAN. The bundled vehicle catalog is
available offline immediately and checks gt-telemetry for updates at startup.
